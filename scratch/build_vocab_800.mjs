...
const words800 = [
  // Original 800+ preserved with cleaned emoji
  {
    id: "v1",
    word: "corporate merger",
    ipa: "/ˈkɔːrpərət ˈmɜːrdʒər/",
    vietnamese: "sáp nhập doanh nghiệp, hợp nhất tập đoàn",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The multi-billion-dollar corporate merger created the largest telecommunications entity in the country.",
  ...
  },
  {
    ...
    word: "sacrifice",
    ipa: "/ˈsækrɪfaɪs/",
    vietnamese: "hy sinh, đánh đổi lợi ích ngắn hạn",
    partOfSpeech: "verb/noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The founders sacrificed short-term quarterly dividends to invest aggressively in research.",
  ...
  // 113 New Advanced 800+ Words
  {
    id: "v291",
    word: "adversely",
    ipa: "/ædˈvɜːrsli/",
    vietnamese: "bất lợi, tiêu cực, có hại",
    partOfSpeech: "adv",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "High inflation rates adversely affected domestic consumer purchasing power.",
  ...
  },
  {
    ...
    word: "amicably",
    ipa: "/ˈæmɪkəbli/",
    vietnamese: "một cách êm đẹp, hòa giải thân thiện",
    partOfSpeech: "adv",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The contractual dispute was settled amicably out of court following mediation.",
  ...
  },
  {
    ...
    word: "arbitration",
    ipa: "/ˌɑːrbɪˈtreɪʃn/",
    vietnamese: "sự phân xử của trọng tài thương mại độc lập",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The commercial contract requires both parties to submit grievances to binding arbitration.",
  ...
  },
  {
    ...
    word: "breach",
    ipa: "/briːtʃ/",
    vietnamese: "sự vi phạm (hợp đồng, an ninh, điều khoản)",
    partOfSpeech: "noun/verb",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "Failure to deliver the agreed merchandise constitutes a material breach of contract.",
  ...
  },
  {
    ...
    word: "collusion",
    ipa: "/kəˈluːʒn/",
    vietnamese: "sự câu kết cấu kết bất chính (làm giá, gian lận thầu)",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "Antitrust regulators investigated whether airlines engaged in price collusion.",
  ...
  },
  {
    ...
    word: "commensurate",
    ipa: "/kəˈmenʃərət/",
    vietnamese: "tương xứng, phù hợp theo tỷ lệ",
    partOfSpeech: "adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "Salary and bonus packages will be commensurate with professional experience and qualifications.",
  ...
  },
  {
    ...
    word: "conglomerate",
    ipa: "/kənˈɡlɑːmərət/",
    vietnamese: "tập đoàn đa ngành khổng lồ",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The multinational conglomerate operates subsidiaries in shipping, electronics, and banking.",
  ...
  },
  {
    ...
    word: "contingent",
    ipa: "/kənˈtɪndʒənt/",
    vietnamese: "tùy thuộc vào, dựa trên điều kiện; đoàn đại biểu",
    partOfSpeech: "adj/noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The final closing of the acquisition is contingent upon antitrust regulatory approval.",
  ...
  },
  {
    ...
    word: "cumbersome",
    ipa: "/ˈkʌmbərsəm/",
    vietnamese: "cồng kềnh, phiền toái chậm chạp (thủ tục, máy móc)",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The corporation reformed its cumbersome procurement procedures to accelerate project timelines.",
  ...
  },
  {
    ...
    word: "curtail",
    ipa: "/kɜːrˈteɪl/",
    vietnamese: "cắt giảm, rút ngắn bớt (chi tiêu, hoạt động)",
    partOfSpeech: "verb",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Management had to curtail business travel expenditures to maintain quarterly profitability.",
  ...
  },
  {
    ...
    word: "diligent",
    ipa: "/ˈdɪlɪdʒənt/",
    vietnamese: "siêng năng cẩn trọng, chu đáo hết mình",
    partOfSpeech: "adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "Through diligent research and tireless effort, the forensic auditor uncovered accounting fraud.",
  ...
  },
  {
    ...
    word: "disclaimer",
    ipa: "/dɪsˈkleɪmər/",
    vietnamese: "lời tuyên bố miễn trừ trách nhiệm pháp lý",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The investment prospectus includes a legal disclaimer noting that past performance does not guarantee future results.",
  ...
  },
  {
    ...
    word: "discrepancy",
    ipa: "/dɪˈskrepənsi/",
    vietnamese: "sự sai lệch, bất nhất giữa các số liệu",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Auditors detected a substantial discrepancy between recorded receipts and bank deposits.",
  ...
  },
  {
    ...
    word: "discretionary",
    ipa: "/dɪˈskreʃəneri/",
    vietnamese: "tùy ý quyết định, không bắt buộc; tự do định đoạt",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Households curtailed discretionary spending on entertainment during the recession.",
  ...
  },
  {
    ...
    word: "disparate",
    ipa: "/ˈdɪspərət/",
    vietnamese: "khác biệt hoàn toàn, tách biệt không đồng nhất",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The new enterprise software integrates data across disparate branch computer systems.",
  ...
  },
  {
    ...
    word: "durability",
    ipa: "/ˌdʊrəˈbɪləti/",
    vietnamese: "độ bền lâu dài của sản phẩm/vật liệu",
    partOfSpeech: "noun",
    category: "Manufacturing & Quality",
    targetBand: "800+",
    examples: [
      "Engineers subjected the carbon-fiber frame to extreme stress tests to verify its durability.",
  ...
  },
  {
    ...
    word: "equity",
    ipa: "/ˈekwəti/",
    vietnamese: "vốn chủ sở hữu, cổ phần công ty; sự công bằng",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The venture fund received a twenty-percent equity stake in the biotech startup.",
  ...
  },
  {
    ...
    word: "equivocal",
    ipa: "/ɪˈkwɪvəkl/",
    vietnamese: "nước đôi, mập mờ không rõ ràng",
    partOfSpeech: "adj",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The witness gave equivocal answers when questioned by corporate investigators.",
  ...
  },
  {
    ...
    word: "exemplary",
    ipa: "/ɪɡˈzempləri/",
    vietnamese: "gương mẫu, mẫu mực, đáng noi theo",
    partOfSpeech: "adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "She received an award for her exemplary leadership during the facility relocation.",
  ...
  },
  {
    ...
    word: "exorbitant",
    ipa: "/ɪɡˈzɔːrbɪtənt/",
    vietnamese: "cắt cổ, quá mức hợp lý (giá cả, chi phí)",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Tenants refused to pay the exorbitant rent increases proposed by the landlord.",
  ...
  },
  {
    ...
    word: "expedient",
    ipa: "/ɪkˈspiːdiənt/",
    vietnamese: "phương kế tiện lợi thực dụng dù chưa hẳn lý tưởng",
    partOfSpeech: "adj/noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Management chose the most politically expedient solution rather than addressing core flaws.",
  ...
  },
  {
    ...
    word: "extrapolate",
    ipa: "/ɪkˈstræpəleɪt/",
    vietnamese: "ngoại suy, suy đoán tương lai dựa trên dữ liệu hiện có",
    partOfSpeech: "verb",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Economists extrapolated future inflation trends from thirty years of historical data.",
  ...
  },
  {
    ...
    word: "feasibility",
    ipa: "/ˌfiːzəˈbɪləti/",
    vietnamese: "tính khả thi của một dự án công trình",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The engineering firm conducted an in-depth feasibility study for the offshore wind farm.",
  ...
  },
  {
    ...
    word: "fiduciary",
    ipa: "/fɪˈduːʃieri/",
    vietnamese: "ủy thác niềm tin; trách nhiệm pháp lý vì quyền lợi thân chủ",
    partOfSpeech: "adj/noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Corporate directors have a strict fiduciary duty to act in the best interests of shareholders.",
  ...
  },
  {
    ...
    word: "fluctuation",
    ipa: "/ˌflʌktʃuˈeɪʃn/",
    vietnamese: "sự dao động bất thường của thị trường giá cả",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Exporters use foreign exchange hedging to protect against currency fluctuations.",
  ...
  },
  {
    ...
    word: "formidable",
    ipa: "/ˈfɔːrmɪdəbl/",
    vietnamese: "đáng gờm, ghê gớm, thách thức lớn",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The tech giant represents a formidable competitor in the cloud storage market.",
  ...
  },
  {
    ...
    word: "imperative",
    ipa: "/ɪmˈperətɪv/",
    vietnamese: "cấp bách, bắt buộc phải làm ngay",
    partOfSpeech: "adj/noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "It is imperative that all flight attendants complete recurrent emergency evacuation drills.",
  ...
  },
  {
    ...
    word: "impending",
    ipa: "/ɪmˈpendɪŋ/",
    vietnamese: "sắp xảy đến, cận kề (thường là sự kiện lớn hoặc khó khăn)",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Employees were briefed about the impending corporate restructuring and leadership changes.",
  ...
  },
  {
    ...
    word: "indemnify",
    ipa: "/ɪnˈdemnɪfaɪ/",
    vietnamese: "bồi thường thiệt hại, cam kết bảo lãnh trách nhiệm",
    partOfSpeech: "verb",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The contractor agreed to indemnify the building owner against any third-party injury claims.",
  ...
  },
  {
    ...
    word: "indispensable",
    ipa: "/ˌɪndɪˈspensəbl/",
    vietnamese: "không thể thiếu được, thiết yếu tuyệt đối",
    partOfSpeech: "adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "Her deep knowledge of Asian supply chains made her indispensable to the corporate board.",
  ...
  },
  {
    ...
    word: "inevitable",
    ipa: "/ɪnˈevɪtəbl/",
    vietnamese: "chắc chắn xảy ra, không thể tránh khỏi",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Given the mounting debt burden, corporate restructuring had become completely inevitable.",
  ...
  },
  {
    ...
    word: "inflexible",
    ipa: "/ɪnˈfleksəbl/",
    vietnamese: "cứng nhắc, không linh hoạt thỏa hiệp",
    partOfSpeech: "adj",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The supplier's inflexible payment policies caused several retail clients to switch vendors.",
  ...
  },
  {
    ...
    word: "injunction",
    ipa: "/ɪnˈdʒʌŋkʃn/",
    vietnamese: "lệnh cấm của tòa án",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The patent holder sought a court injunction to halt sales of the infringing smartphone.",
  ...
  },
  {
    ...
    word: "insolvent",
    ipa: "/ɪnˈsɑːlvənt/",
    vietnamese: "vỡ nợ, mất khả năng thanh toán",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The airline was declared insolvent after accumulating billions in unpaid aircraft leases.",
  ...
  },
  {
    ...
    word: "instigate",
    ipa: "/ˈɪnstɪɡeɪt/",
    vietnamese: "khởi xướng tiến hành (cuộc thanh tra, cải tổ)",
    partOfSpeech: "verb",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The new CEO instigated an exhaustive review of all underperforming subsidiaries.",
  ...
  },
  {
    ...
    word: "judicious",
    ipa: "/dʒuːˈdɪʃəs/",
    vietnamese: "sáng suốt, khôn ngoan và đúng mực",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Through judicious allocation of capital, the portfolio manager achieved superior returns.",
  ...
  },
  {
    ...
    word: "jurisdiction",
    ipa: "/ˌdʒʊrɪsˈdɪkʃn/",
    vietnamese: "thẩm quyền pháp lý, khu vực tài phán",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The contract specifies that any legal disputes fall under the jurisdiction of New York courts.",
  ...
  },
  {
    ...
    word: "litigation",
    ipa: "/ˌlɪtɪˈɡeɪʃn/",
    vietnamese: "sự kiện tụng tranh chấp tại tòa án",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "Protracted patent litigation between the tech competitors dragged on for four years.",
  ...
  },
  {
    ...
    word: "liquidity",
    ipa: "/lɪˈkwɪdəti/",
    vietnamese: "tính thanh khoản, khả năng chuyển đổi thành tiền mặt",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Central banks lowered reserve requirements to inject liquidity into the commercial banking system.",
  ...
  },
  {
    ...
    word: "meticulous",
    ipa: "/məˈtɪkjələs/",
    vietnamese: "tỉ mỉ, cẩn thận chu đáo từng chi tiết nhỏ",
    partOfSpeech: "adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "The forensic auditor conducted a meticulous examination of seven years of financial records.",
  ...
  },
  {
    ...
    targetBand: "800+",
    examples: [
      "Antitrust regulators sued the utility provider for abusing its regional electricity monopoly.",
  ...
  },
  {
    ...
    word: "negligence",
    ipa: "/ˈneɡlɪdʒəns/",
    vietnamese: "sự cẩu thả, bất cẩn gây hậu quả pháp lý",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The construction contractor was sued for professional negligence after the ceiling caved in.",
  ...
  },
  {
    ...
    word: "null and void",
    ipa: "/ˌnʌl ən ˈvɔɪd/",
    vietnamese: "vô hiệu lực pháp lý, không còn giá trị",
    partOfSpeech: "phrase",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "If either signature is omitted, the commercial warranty becomes null and void.",
  ...
  },
  {
    ...
    word: "overhaul",
    ipa: "/ˈoʊvərhɔːl/",
    vietnamese: "đại tu máy móc; cải tổ toàn diện hệ thống",
    partOfSpeech: "noun/verb",
    category: "Manufacturing & Quality",
    targetBand: "800+",
    examples: [
      "The railway operator commissioned a comprehensive multi-million-dollar locomotive engine overhaul.",
  ...
  },
  {
    ...
    word: "paradigm",
    ipa: "/ˈpærədaɪm/",
    vietnamese: "mô hình mẫu, hệ hình tư duy",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Remote work software sparked a fundamental paradigm shift in modern corporate culture.",
  ...
  },
  {
    ...
    word: "precedent",
    ipa: "/ˈpresɪdənt/",
    vietnamese: "án lệ, tiền lệ trong phán quyết và quản trị",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The supreme court's landmark ruling established a strong legal precedent for data privacy.",
  ...
  },
  {
    ...
    word: "precarious",
    ipa: "/prɪˈkeriəs/",
    vietnamese: "bấp bênh, nguy hiểm không vững chắc",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Mounting foreign debt placed the manufacturing firm in a precarious financial position.",
  ...
  },
  {
    ...
    word: "predecessor",
    ipa: "/ˈpredəsesər/",
    vietnamese: "người tiền nhiệm, thiết bị đời trước",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "The incoming chief executive officer praised her predecessor for steering the firm through crisis.",
  ...
  },
  {
    ...
    word: "prerequisite",
    ipa: "/ˌpriːˈrekwəzɪt/",
    vietnamese: "điều kiện tiên quyết, yêu cầu bắt buộc trước",
    partOfSpeech: "noun/adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "A certified background in data architecture is an essential prerequisite for this engineering role.",
  ...
  },
  {
    ...
    word: "privatization",
    ipa: "/ˌpraɪvətəˈzeɪʃn/",
    vietnamese: "sự tư nhân hóa doanh nghiệp nhà nước",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The government announced the complete privatization of the state-owned postal network.",
  ...
  },
  {
    ...
    word: "reciprocal",
    ipa: "/rɪˈsɪprəkl/",
    vietnamese: "hai chiều, tương hỗ, có đi có lại",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Both countries negotiated a reciprocal trade pact eliminating import duties on farm commodities.",
  ...
  },
  {
    ...
    word: "reconciliation",
    ipa: "/ˌrekənsɪliˈeɪʃn/",
    vietnamese: "sự đối chiếu khớp số dư tài khoản; sự hòa giải",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The senior accountant completed the monthly bank reconciliation before submitting the ledger.",
  ...
  },
  {
    ...
    word: "redress",
    ipa: "/rɪˈdres/",
    vietnamese: "sự đền bù thỏa đáng, khắc phục thiệt hại",
    partOfSpeech: "noun/verb",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "Aggrieved investors sought legal redress for misleading financial statements issued by the board.",
  ...
  },
  {
    ...
    word: "redundant",
    ipa: "/rɪˈdʌndənt/",
    vietnamese: "dư thừa, không cần thiết; bị sa thải do tinh giản biên chế",
    partOfSpeech: "adj",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "Automating spreadsheet entry made several manual administrative positions redundant.",
  ...
  },
  {
    ...
    word: "remuneration",
    ipa: "/rɪˌmjuːnəˈreɪʃn/",
    vietnamese: "thù lao, tiền công trả cho người lao động",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "800+",
    examples: [
      "Executive remuneration packages are subject to annual advisory votes by public shareholders.",
  ...
  },
  {
    ...
    vietnamese: "sự tái cơ cấu tổ chức/tài chính",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The corporate restructuring consolidated seven regional branches into three streamlined hubs.",
  ...
  },
  {
    ...
    word: "rigorous",
    ipa: "/ˈrɪɡərəs/",
    vietnamese: "nghiêm ngặt, khắt khe chuẩn xác",
    partOfSpeech: "adj",
    category: "Manufacturing & Quality",
    targetBand: "800+",
    examples: [
      "The new pharmaceutical compound underwent rigorous laboratory testing for three years.",
  ...
  },
  {
    ...
    word: "scrutinize",
    ipa: "/ˈskruːtənaɪz/",
    vietnamese: "soi xét kỹ lưỡng, kiểm tra tỉ mỉ",
    partOfSpeech: "verb",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Tax authorities scrutinized the corporation's offshore consulting transactions.",
  ...
  },
  {
    ...
    word: "solvency",
    ipa: "/ˈsɑːlvənsi/",
    vietnamese: "khả năng thanh toán nợ nần dài hạn",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The commercial bank's solvency was confirmed by the national central banking regulator.",
  ...
  },
  {
    ...
    word: "speculative",
    ipa: "/ˈspekjələtɪv/",
    vietnamese: "mang tính đầu cơ rủi ro cao",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Financial advisers cautioned clients against investing in highly speculative digital assets.",
  ...
  },
  {
    ...
    word: "stakeholder",
    ipa: "/ˈsteɪkhoʊldər/",
    vietnamese: "các bên liên quan (cổ đông, nhân viên, cộng đồng)",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The corporate board consulted key stakeholders before announcing the plant relocation.",
  ...
  },
  {
    ...
    word: "statutory",
    ipa: "/ˈstætʃətɔːri/",
    vietnamese: "theo luật định, do luật pháp quy định",
    partOfSpeech: "adj",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "All employers are subject to a statutory obligation to provide safe working conditions.",
  ...
  },
  {
    ...
    word: "stipulate",
    ipa: "/ˈstɪpjuleɪt/",
    vietnamese: "quy định rõ ràng trong điều khoản hợp đồng",
    partOfSpeech: "verb",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The vendor contract stipulates that late deliveries incur a five percent price discount.",
  ...
  },
  {
    ...
    word: "stringent",
    ipa: "/ˈstrɪndʒənt/",
    vietnamese: "nghiêm ngặt, chặt chẽ, khắt khe",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "Aviation safety regulators enforce stringent inspection rules on jet engine maintenance.",
  ...
  },
  {
    ...
    word: "subsidiary",
    ipa: "/səbˈsɪdieri/",
    vietnamese: "công ty con trực thuộc tập đoàn mẹ",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The European technology subsidiary generates forty percent of the parent company's profit.",
  ...
  },
  {
    ...
    word: "succession",
    ipa: "/səkˈseʃn/",
    vietnamese: "sự kế vị lãnh đạo, chuỗi nối tiếp",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The board enacted its executive succession plan following the chief executive's retirement.",
  ...
  },
  {
    ...
    word: "syndicate",
    ipa: "/ˈsɪndɪkət/",
    vietnamese: "công-xoóc-xi-um, nhóm liên hiệp tài chính/ngân hàng",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "A syndicate of five international banks provided financing for the deep-water port project.",
  ...
  },
  {
    ...
    word: "tentative",
    ipa: "/ˈtentətɪv/",
    vietnamese: "dự kiến, ướm thử chưa chính thức chốt",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The negotiating teams reached a tentative agreement on wage adjustments late last night.",
  ...
  },
  {
    ...
    word: "tolerance",
    ipa: "/ˈtɑːlərəns/",
    vietnamese: "dung sai kỹ thuật cho phép; sự kiên nhẫn dung thứ",
    partOfSpeech: "noun",
    category: "Manufacturing & Quality",
    targetBand: "800+",
    examples: [
      "Aircraft turbine blades are machined to a tolerance of within one hundredth of a millimeter.",
  ...
  },
  {
    ...
    word: "turnaround",
    ipa: "/ˈtɜːrnəraʊnd/",
    vietnamese: "sự xoay chuyển tình thế ngoạn mục; thời gian quay vòng",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The newly appointed CEO orchestrated an astonishing turnaround in profitability within one year.",
  ...
  },
  {
    ...
    word: "unambiguous",
    ipa: "/ˌʌnæmˈbɪɡjuəs/",
    vietnamese: "rõ ràng rành mạch, không thể hiểu lầm",
    partOfSpeech: "adj",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The contract language provides unambiguous guidance regarding warranty liability.",
  ...
  },
  {
    ...
    word: "unanimous",
    ipa: "/juˈnænɪməs/",
    vietnamese: "nhất trí tuyệt đối, đồng thuận một trăm phần trăm",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The board of directors passed a unanimous resolution approving the corporate buyout.",
  ...
  },
  {
    ...
    word: "unprecedented",
    ipa: "/ʌnˈpresɪdentɪd/",
    vietnamese: "chưa từng có tiền lệ trong lịch sử",
    partOfSpeech: "adj",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The tech company experienced an unprecedented surge in online software subscriptions.",
  ...
  },
  {
    ...
    vietnamese: "vốn đầu tư mạo hiểm cho khởi nghiệp",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The artificial intelligence startup secured twenty million dollars in venture capital.",
  ...
  },
  {
    ...
    word: "volatile",
    ipa: "/ˈvɑːlətl/",
    vietnamese: "dễ biến động dữ dội, thất thường (thị trường, giá)",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Crude oil prices remained highly volatile due to ongoing geopolitical instability.",
  ...
  },
  {
    ...
    word: "accrual",
    ipa: "/əˈkruːəl/",
    vietnamese: "khoản phát sinh tích lũy (kế toán dồn tích)",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Under accrual accounting, revenues and expenses are recorded when incurred, not when paid.",
  ...
  },
  {
    ...
    word: "amortization",
    ipa: "/ˌæmərtəˈzeɪʃn/",
    vietnamese: "sự khấu hao tài sản vô hình / trả dần nợ gốc lãi",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The corporate financial balance sheet includes annual amortization of patent acquisition fees.",
  ...
  },
  {
    ...
    word: "arbitrage",
    ipa: "/ˈɑːrbɪtrɑːʒ/",
    vietnamese: "kinh doanh chênh lệch giá giữa các thị trường",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "High-frequency algorithmic traders exploit currency arbitrage opportunities across exchanges.",
  ...
  },
  {
    ...
    word: "contingency",
    ipa: "/kənˈtɪndʒənsi/",
    vietnamese: "sự cố bất ngờ; kế hoạch dự phòng khẩn cấp",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "800+",
    examples: [
      "The construction budget includes a ten percent reserve for unforeseen site contingencies.",
  ...
  },
  {
    ...
    word: "default",
    ipa: "/dɪˈfɔːlt/",
    vietnamese: "sự vỡ nợ không trả được nợ; mặc định",
    partOfSpeech: "noun/verb",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "The commercial property developer was on the verge of default following sales slumps.",
  ...
  },
  {
    ...
    word: "deflationary",
    ipa: "/ˌdiːˈfleɪʃəneri/",
    vietnamese: "mang tính giảm phát kinh tế",
    partOfSpeech: "adj",
    category: "Finance & Accounting",
    targetBand: "800+",
    examples: [
      "Economists warned that persistent deflationary pressures could stifle consumer retail demand.",
  ...
  },
  {
    ...
    word: "calibrate",
    ipa: "/ˈkælɪbreɪt/",
    vietnamese: "hiệu chuẩn, căn chỉnh độ chuẩn xác của máy đo",
    partOfSpeech: "verb",
    category: "Manufacturing & Quality",
    targetBand: "800+",
    examples: [
      "Technicians must calibrate optical measuring sensors every morning before fabrication commences.",
  ...
  },
  {
    ...
    ipa: "/ɪnˌdemnɪfɪˈkeɪʃn/",
    vietnamese: "sự bồi thường tổn thất pháp lý, điều khoản bồi hoàn",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "800+",
    examples: [
      "The software vendor agreed to provide intellectual property indemnification to all commercial licensees.",
...
// Write file for 800
const content800 = `import { VocabularyWord } from '../vocabulary';

export const VOCAB_800: VocabularyWord[] = ${JSON.stringify(words800, null, 2)};
`;

fs.writeFileSync(path.resolve('src/data/vocab/vocab_800.ts'), content800, 'utf-8');
console.log(`Successfully generated vocab_800.ts with ${words800.length} words.`);
