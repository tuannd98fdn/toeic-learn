...
// --- BAND 450+ (~123 words: v4, v5, v8, v9, v13, v14, v16, v17, v23, v26, v30, v31, v34 + new words v35..v144) ---
const words450 = [
  // Original 450+ preserved with cleaned emoji
  {
    id: "v4",
    word: "advertisement",
    ipa: "/ˌædvərˈtaɪzmənt/",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The annual sales conference attracted many regional managers.",
  ...
  },
  {
    ...
    word: "protective",
    ipa: "/prəˈtektɪv/",
    vietnamese: "mang tính bảo hộ, bảo vệ",
    partOfSpeech: "adj",
    category: "Manufacturing & Quality",
    targetBand: "450+",
    examples: [
      "Factory visitors are required to wear protective eyewear and hard hats.",
  ...
  },
  {
    ...
    word: "seek",
    ipa: "/siːk/",
    vietnamese: "tìm kiếm, theo đuổi",
    partOfSpeech: "verb",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "The accounting firm is seeking qualified applicants for junior auditor positions.",
  ...
  // New High-Frequency 450+ Words
  {
    id: "v35",
    word: "agenda",
    ipa: "/əˈdʒendə/",
    vietnamese: "chương trình nghị sự, lịch trình cuộc họp",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "450+",
    examples: [
      "Please review the meeting agenda before tomorrow morning.",
  ...
  },
  {
    ...
    word: "applicant",
    ipa: "/ˈæplɪkənt/",
    vietnamese: "người nộp đơn, ứng viên",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "The job posting attracted more than fifty qualified applicants.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "All team leads are expected to attend the project briefing.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "Passengers may claim their baggage at carousel number four.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The monthly electricity bill must be paid before the end of the month.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "Please display your passport and boarding pass at the departure gate.",
  ...
  },
  {
    ...
    word: "branch",
    ipa: "/bræntʃ/",
    vietnamese: "chi nhánh, phân nhánh",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "450+",
    examples: [
      "The bank opened a new branch in the central shopping district.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The proposed marketing campaign was approved within the annual budget.",
  ...
  },
  {
    ...
    word: "candidate",
    ipa: "/ˈkændɪdət/",
    vietnamese: "ứng viên xin việc",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "The interview committee will select the most qualified candidate today.",
  ...
  },
  {
    ...
    word: "cashier",
    ipa: "/kæˈʃɪr/",
    vietnamese: "nhân viên thu ngân",
    partOfSpeech: "noun",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "Please proceed to the cashier counter to complete your purchase.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "She collaborated closely with her colleagues to finalize the proposal.",
  ...
  },
  {
    ...
    word: "commute",
    ipa: "/kəˈmjuːt/",
    vietnamese: "quãng đường đi làm hàng ngày, đi lại",
    partOfSpeech: "verb/noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "Many suburban residents commute to the city center by passenger train.",
  ...
  },
  {
    ...
    word: "contract",
    ipa: "/ˈkɑːntrækt/",
    vietnamese: "hợp đồng giao kết",
    partOfSpeech: "noun",
    category: "Contracts & Legal",
    targetBand: "450+",
    examples: [
      "Both parties signed the two-year employment contract yesterday.",
  ...
  },
  {
    ...
    word: "customer",
    ipa: "/ˈkʌstəmər/",
    vietnamese: "khách mua hàng",
    partOfSpeech: "noun",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "Customer satisfaction is the primary objective of our retail chain.",
  ...
  },
  {
    ...
    word: "deadline",
    ipa: "/ˈdedlaɪn/",
    vietnamese: "hạn chót, thời hạn hoàn thành",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "450+",
    examples: [
      "The submission deadline for the design contest is Friday afternoon.",
  ...
  },
  {
    ...
    word: "department",
    ipa: "/dɪˈpɑːrtmənt/",
    vietnamese: "phòng ban, bộ phận chuyên trách",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "450+",
    examples: [
      "She transferred to the accounting department at the start of the fiscal quarter.",
  ...
  },
  {
    ...
    word: "discount",
    ipa: "/ˈdɪskaʊnt/",
    vietnamese: "khoản giảm giá, chiết khấu",
    partOfSpeech: "noun/verb",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "Customers who present a membership card receive a ten percent discount.",
  ...
  },
  {
    ...
    word: "display",
    ipa: "/dɪˈspleɪ/",
    vietnamese: "trưng bày, màn hình hiển thị",
    partOfSpeech: "verb/noun",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "New electronics are prominently displayed in the front window.",
  ...
  },
  {
    ...
    word: "estimate",
    ipa: "/ˈestɪmət/",
    vietnamese: "bản dự toán, ước tính",
    partOfSpeech: "noun/verb",
    category: "Finance & Accounting",
    targetBand: "450+",
    examples: [
      "The mechanic provided a written cost estimate before repairing the vehicle.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "Her direct flight to Chicago departs at quarter past seven.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The multinational corporation relocated its corporate headquarters to Dallas.",
  ...
  },
  {
    ...
    word: "hire",
    ipa: "/ˈhaɪər/",
    vietnamese: "tuyển dụng, thuê nhân viên",
    partOfSpeech: "verb",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "The software studio plans to hire ten new programmers this autumn.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "He wore a professional navy suit to his second-round job interview.",
  ...
  },
  {
    ...
    word: "invoice",
    ipa: "/ˈɪnvɔɪs/",
    vietnamese: "hóa đơn xuất hàng, chứng từ thanh toán",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "450+",
    examples: [
      "The accounting department will issue an invoice upon dispatch of goods.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The executive assistant prepared a detailed travel itinerary for the director.",
  ...
  },
  {
    ...
    word: "luggage",
    ipa: "/ˈlʌɡɪdʒ/",
    vietnamese: "hành lý tư trang",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "Do not leave your luggage unattended anywhere inside the terminal.",
  ...
  },
  {
    ...
    word: "maintenance",
    ipa: "/ˈmeɪntənəns/",
    vietnamese: "sự bảo dưỡng, bảo trì",
    partOfSpeech: "noun",
    category: "Manufacturing & Quality",
    targetBand: "450+",
    examples: [
      "Regular vehicle maintenance prevents unexpected mechanical failures.",
  ...
  },
  {
    ...
    word: "manager",
    ipa: "/ˈmænɪdʒər/",
    vietnamese: "người quản lý, trưởng phòng",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "450+",
    examples: [
      "The store manager addressed customer concerns with patience and courtesy.",
  ...
  },
  {
    ...
    word: "passenger",
    ipa: "/ˈpæsɪndʒər/",
    vietnamese: "hành khách đi tàu xe máy bay",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "All passengers are requested to fasten their seatbelts during turbulence.",
  ...
  },
  {
    ...
    word: "passport",
    ipa: "/ˈpæspɔːrt/",
    vietnamese: "hộ chiếu xuất nhập cảnh",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "Ensure your passport is valid for at least six months before international travel.",
  ...
  },
  {
    ...
    word: "purchase",
    ipa: "/ˈpɜːrtʃəs/",
    vietnamese: "mua, đơn mua hàng",
    partOfSpeech: "verb/noun",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "Keep your original receipt as proof of purchase for warranty claims.",
  ...
  },
  {
    ...
    word: "receipt",
    ipa: "/rɪˈsiːt/",
    vietnamese: "biên lai thanh toán",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "450+",
    examples: [
      "Attach all sales receipts to your expense reimbursement report.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The receptionist greeted incoming visitors and signed them into the guestbook.",
  ...
  },
  {
    ...
    word: "refund",
    ipa: "/ˈriːfʌnd/",
    vietnamese: "tiền hoàn lại, khoản trả lại",
    partOfSpeech: "noun/verb",
    category: "Finance & Accounting",
    targetBand: "450+",
    examples: [
      "Customers are entitled to a full refund within thirty days of purchase.",
  ...
  },
  {
    ...
    word: "repair",
    ipa: "/rɪˈper/",
    vietnamese: "sửa chữa, khắc phục sự cố",
    partOfSpeech: "verb/noun",
    category: "Manufacturing & Quality",
    targetBand: "450+",
    examples: [
      "A technician arrived promptly to repair the jammed copy machine.",
  ...
  },
  {
    ...
    word: "reservation",
    ipa: "/ˌrezərˈveɪʃn/",
    vietnamese: "sự đặt chỗ trước (phòng, bàn, vé)",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "I would like to make a table reservation for four people at seven o'clock.",
  ...
  },
  {
    ...
    word: "resume",
    ipa: "/ˈrezəmeɪ/",
    vietnamese: "sơ yếu lý lịch xin việc",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "Please forward your resume and cover letter to our recruitment department.",
  ...
  },
  {
    ...
    word: "supervisor",
    ipa: "/ˈsuːpərvaɪzər/",
    vietnamese: "người giám sát, quản đốc",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "Report any workplace safety hazards directly to your shift supervisor.",
  ...
  },
  {
    ...
    word: "terminal",
    ipa: "/ˈtɜːrmɪnl/",
    vietnamese: "nhà ga sân bay, bến bãi cuối",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "Free shuttle buses run between Terminal 1 and Terminal 2 every ten minutes.",
  ...
  },
  {
    ...
    word: "ticket",
    ipa: "/ˈtɪkɪt/",
    vietnamese: "vé vào cửa, vé tàu xe",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "Concert tickets can be booked online or purchased at the box office window.",
  ...
  },
  {
    ...
    word: "vacancy",
    ipa: "/ˈveɪkənsi/",
    vietnamese: "vị trí còn trống, phòng còn trống",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "Our accounting firm currently has a job vacancy for a senior tax specialist.",
  ...
  },
  {
    ...
    word: "workshop",
    ipa: "/ˈwɜːrkʃɑːp/",
    vietnamese: "buổi hội thảo thực hành, khóa tập huấn",
    partOfSpeech: "noun",
    category: "Corporate & Management",
    targetBand: "450+",
    examples: [
      "The company sponsored a weekend workshop on effective digital marketing.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "Management will announce the promotion list at Friday's staff meeting.",
  ...
  },
  {
    ...
    word: "assistant",
    ipa: "/əˈsɪstənt/",
    vietnamese: "trợ lý, người phụ tá",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "The administrative assistant handles telephone inquiries and calendar bookings.",
  ...
  },
  {
    ...
    word: "banquet",
    ipa: "/ˈbæŋkwɪt/",
    vietnamese: "bữa tiệc lớn, yến tiệc",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "The company's annual awards banquet will be hosted in the Grand Ballroom.",
  ...
  },
  {
    ...
    word: "clerk",
    ipa: "/klɜːrk/",
    vietnamese: "nhân viên bàn giấy, nhân viên bán hàng",
    partOfSpeech: "noun",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "The front desk clerk handed the keys to the hotel guest.",
  ...
  },
  {
    ...
    word: "coupon",
    ipa: "/ˈkuːpɑːn/",
    vietnamese: "phiếu ưu đãi giảm giá",
    partOfSpeech: "noun",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "Customers can redeem this digital discount coupon at checkout.",
  ...
  },
  {
    ...
    word: "operate",
    ipa: "/ˈɑːpəreɪt/",
    vietnamese: "vận hành máy móc, điều hành",
    partOfSpeech: "verb",
    category: "Manufacturing & Quality",
    targetBand: "450+",
    examples: [
      "Only authorized personnel are permitted to operate the heavy warehouse machinery.",
  ...
  },
  {
    ...
    word: "platform",
    ipa: "/ˈplætfɔːrm/",
    vietnamese: "sân ga xe lửa; nền tảng công nghệ",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "The express train bound for Boston will arrive at platform three.",
  ...
  },
  {
    ...
    word: "replace",
    ipa: "/rɪˈpleɪs/",
    vietnamese: "thay thế bộ phận / đổi vị trí",
    partOfSpeech: "verb",
    category: "Manufacturing & Quality",
    targetBand: "450+",
    examples: [
      "The building superintendent will replace the burned-out hallway light fixtures.",
  ...
  },
  {
    ...
    word: "aisle",
    ipa: "/aɪl/",
    vietnamese: "lối đi giữa các hàng ghế hoặc kệ hàng",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "Would you prefer an aisle seat or a window seat for this flight?",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "Complimentary hot beverages are offered in the waiting lounge.",
  ...
  },
  {
    ...
    targetBand: "450+",
    examples: [
      "The flight attendant demonstrated emergency safety procedures.",
  ...
  },
  {
    ...
    word: "laundry",
    ipa: "/ˈlɔːndri/",
    vietnamese: "việc giặt ủi, đồ giặt",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "The hotel offers same-day dry cleaning and laundry services for business guests.",
  ...
  },
  {
    ...
    word: "overtime",
    ipa: "/ˈoʊvərtaɪm/",
    vietnamese: "giờ làm thêm, tăng ca",
    partOfSpeech: "noun/adv",
    category: "Personnel & HR",
    targetBand: "450+",
    examples: [
      "Employees who work overtime on weekends receive time-and-a-half pay.",
  ...
  },
  {
    ...
    word: "shuttle",
    ipa: "/ˈʃʌtl/",
    vietnamese: "xe đưa đón tuyến cố định",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "A complimentary airport shuttle runs every twenty minutes between the terminal and hotel.",
  ...
  },
  {
    ...
    word: "turnstile",
    ipa: "/ˈtɜːrnstaɪl/",
    vietnamese: "cổng xoay kiểm soát vé/thẻ",
    partOfSpeech: "noun",
    category: "Travel & Hospitality",
    targetBand: "450+",
    examples: [
      "Scan your electronic train ticket at the turnstile to access the boarding platform.",
  ...
  },
  {
    ...
    word: "utility",
    ipa: "/juːˈtɪləti/",
    vietnamese: "dịch vụ tiện ích (điện, nước, gas)",
    partOfSpeech: "noun",
    category: "Finance & Accounting",
    targetBand: "450+",
    examples: [
      "Monthly rent includes all standard utilities except internet and telephone.",
  ...
  },
  {
    ...
    word: "vendor",
    ipa: "/ˈvendər/",
    vietnamese: "người bán hàng, nhà cung ứng dịch vụ",
    partOfSpeech: "noun",
    category: "Marketing & Sales",
    targetBand: "450+",
    examples: [
      "Street vendors sold fresh snacks outside the main convention hall.",
...
// Write file for 450
const content450 = `import { VocabularyWord } from '../vocabulary';

export const VOCAB_450: VocabularyWord[] = ${JSON.stringify(words450, null, 2)};
`;

fs.writeFileSync(path.resolve('src/data/vocab/vocab_450.ts'), content450, 'utf-8');
console.log(`Successfully generated vocab_450.ts with ${words450.length} words.`);
