...
part6_data = [
    {
        ...
        "passage": "<p><b>To:</b> All staff<br/><b>From:</b> Leonard Villalobos, Vice President of Product Development<br/><b>Date:</b> August 27<br/><b>Subject:</b> Atzeret game (Product #DS8192)</p><p>Due to the results from our trial customer testing, we have decided to postpone the launch of the Atzeret video game. Customer surveys indicated that the game was less [131] than we anticipated. Over the next few months, the game development team will introduce several [132] to make the product more attractive. [133]. If the changes are successful, we hope to launch the game by next January [134] February.</p>",
        "questions": [
            {
                "id": "ets22_t2_p6_131",
                "number": 131,
    ...
    },
    {
        ...
        "passage": "<p>For a limited time, the Uppercut Clothing Hanger Company is selling its highest quality hangers at huge discounts on wholesale orders. This special [139] is perfect for hotels, retailers, or anywhere hangers are used extensively. [140] of lacquered walnut wood, these hangers are not only durable, but also safe for the environment. [141] are strong enough to hold up to ten pounds. To order, visit www.uppercuthangerco.ca. Note that all orders require a 20 percent deposit. Uppercut will cover all shipping and insurance costs. [142].</p>",
        "questions": [
            {
                "id": "ets22_t2_p6_139",
                "number": 139,
...
print("Successfully wrote public/data/ets2022/test2/part6.json with 4 authentic passages and 16 questions!")
