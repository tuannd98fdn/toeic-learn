...
function ExamSimulation() {
  ...
  // Chỉ chấp nhận đề thi chuẩn đã xác thực (ets2022_test1, ets2022_test2, ets2022_test3, ets2022_test4)
  const testId = ['ets2022_test1', 'ets2022_test2', 'ets2022_test3', 'ets2022_test4'].includes(rawTestId)
    ? rawTestId
    : 'ets2022_test1';
      ...
      <header className={styles.topBar}>
        <div className={styles.barLeft}>
          ...
          <div className={styles.testTitle}>
            {testId === 'ets2022_test4' ? 'ETS 2022 - Test 4' : testId === 'ets2022_test3' ? 'ETS 2022 - Test 3' : testId === 'ets2022_test2' ? 'ETS 2022 - Test 2' : 'ETS 2022 - Test 1'}{' '}
